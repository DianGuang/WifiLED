...
public class EsptouchDemoActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new TimePickerDialog(EsptouchDemoActivity.this, new TimePickerDialog.OnTimeSetListener() {
			@Override
			public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
				String Time= String.format("%d-%d",hourOfDay,minute);
				Toast.makeText(EsptouchDemoActivity.this,Time,Toast.LENGTH_SHORT).show();
			}
		},0,0,true).show();
	}
